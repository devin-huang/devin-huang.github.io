...
实现组件父子间实现双向绑定（由于VUE2不支持），参考：[http://blog.csdn.net/qq_31164127/article/details/78247928](http://blog.csdn.net/qq_31164127/article/details/78247928)

![](/img/pubilc/vue-code.jpg)

原理：子级component定义一个变量和父级创建一个自定义事件，当子级变量变化时促发事件$emit()并执行对应父级函数把子级值传给父级；
